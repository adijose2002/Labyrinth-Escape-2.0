// grid.h
// 
// The goal of this .h file is to define a class Grid<T>, specifically designed to support a
// 2D grid. We need this abstraction in order to create mazes and escape labyrinths later on when testing and run. A grid is
// defined to have a given number of rows and columns, and the resulting elements are initialized to
// C++’s natural default value (4 by 4).
//
// Adithya Jose
